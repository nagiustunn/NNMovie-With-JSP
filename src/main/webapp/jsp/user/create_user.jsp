	...
	<div class="container-fullwidth">
		<div class="row">
			<div class="movie col-md-6 col-md-offset-3">
				<h1 class="well text-center">CREATE USER</h1>
				<div class="col-lg-12 well">
					<div class="row">
						<form action="register_success_user.jsp" method="post">
							<div class="col-sm-12">
									...
									<div class=" form-group">
										<label class="required">Surname</label><input type="text"
											placeholder="Enter User Surname Here..." class="form-control"
											name="surname" required>
									</div>
									<div class=" form-group">
										<label class="required">Epost</label> <input type="text"
											placeholder="Enter User Epost Here.." class="form-control"
											name="epost" required>
									</div>

								<div class=" form-group">
										<label class="required">Password</label> <input type="text"
											placeholder="Enter User Password Here.." class="form-control"
											name="password" id="password" required>									
								</div>
								
								<div class=" form-group">
										<label class="required">Re-Password</label><input type="text"
											placeholder="Again Enter User Password Here.." class="form-control"
											name="re_password" id="re_password" onkeyup="checkPass(); return false;" required>
								...
								<input type="button" value="Back" class="btn btn-lg btn-info" onclick ="location.href='../homepage/homepage.jsp';"
