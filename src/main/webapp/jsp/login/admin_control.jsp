...
ResultSet rs=st.executeQuery("SELECT * FROM admin WHERE epost='"+epost+"' AND password='"+password+"'");
try{
...
{    
		...
		response.sendRedirect("http://localhost:8081/nnmovie/jsp/movie/admin_movie_home.jsp");
