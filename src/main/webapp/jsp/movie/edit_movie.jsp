	...
	<div class="container-fullwidth">
		<div class="row">
			<div class="movie col-md-6 col-md-offset-3">
				<h1 class="well text-center">EDIT MOVIE</h1>
				<div class="col-lg-12 well">
					<div class="row">
						<form action="update_movie.jsp" method="post">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-6 form-group">
										...
										<input type="text"
											class="form-control"
											name="first_name" value="<%=resultSet.getString("name") %>" >
									</div>
									<div class="col-sm-6 form-group">
										<label class="required">Description</label> 
										<input type="text"
											class="form-control"
											name="description" value="<%=resultSet.getString("description") %>" >
									</div>
														
								</div>
								
									<div class="form-group">
									<label class="required">Image Source Path</label>
									<input type="text"
											class="form-control"
											name="img_path" value="<%=resultSet.getString("image_path") %>" >
									</div>
									
								
									<div class="form-group">
										<label class="required">Actor/Actress</label> <input					
											class="form-control" name="email" value="<%=resultSet.getString("actor_actress")%>">
									</div>
								</div>
