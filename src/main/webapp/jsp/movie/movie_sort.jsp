...
<body>
	...
	<div class="col-md-9 form-outline " >
		<form class="d-flex" action="" method="GET" style="margin-left:300px;">
	...
	<table>
		...
		<tbody id="data">
			<%
					...
					String sql ="select * from movie order by pub_year asc";
					...
					<tr>
						...
						<td><a href="inf_movie.jsp?id=<%=resultSet.getString("id")%>""><button type="button" class="btn btn-info">INFO</button></a></td>
						<td>
