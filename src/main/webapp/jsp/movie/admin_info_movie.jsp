...
<head>
	...
	<link rel="stylesheet" href="css/inf_movie.css">
</head>
<body>
	...
	<div class="card" >
		<img src="<%=resultSet.getString("image_path") %>" class="img card-img-top" alt="">
	    <div class='card-body'>
	        <div class='row'>
	          <div class='col-md'>
	              ...
	              <p><b>Publishing Year: </b><%=resultSet.getString("pub_year") %></p>
	              <p><b>Language: </b><%=resultSet.getString("language") %></p>
	              <p><b>Actor/Actrees: </b><%=resultSet.getString("actor_actress") %></p>
	            </div>
	          </div>
	          <button type="button" class="btn btn-info" onclick ="location.href='admin_movie_home.jsp';">BACK</button>
	          <button type="button" class="btn btn-secondary" onclick ="location.href='edit_movie.jsp?id=<%=resultSet.getString("id")%>';">EDIT</button>
	          <button type="button" class="btn btn-danger" onclick ="location.href='delete_movie.jsp';">DELETE</button>
	        </div>
	     </div>
				<%
